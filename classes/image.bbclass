...
include ${@['${WRTEMPLATE_CONF_WRIMAGE}', 'wrnoimage.inc'][d.getVar('WRTEMPLATE_IMAGE', True) != '1']}
include ${@['${WRTEMPLATE_CONF_WRIMAGE_MACH}', 'wrnoimage.inc'][d.getVar('WRTEMPLATE_IMAGE', True) != '1']}
